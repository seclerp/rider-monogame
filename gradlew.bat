...
if "%WIN_ARCH%" equ "AMD64" (
    set JVM_TARGET_DIR=%BUILD_DIR%\amazon-corretto-25-x64-windows-jdk-9e071a\
    set JVM_URL=https://corretto.aws/downloads/latest/amazon-corretto-25-x64-windows-jdk.zip
