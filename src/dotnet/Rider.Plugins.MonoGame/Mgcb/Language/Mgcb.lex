...
<WAITING_OPTION_KEY> {WHITE_SPACE}*{EOL}                    { yybegin(YYINITIAL); return MgcbTokenTypes.WHITE_SPACE; }
<WAITING_OPTION_KEY> {OPTION_SEPARATOR}                     { yybegin(WAITING_OPTION_VALUE); return MgcbTokenTypes.OPTION_SEPARATOR; }
<WAITING_OPTION_VALUE> {WHITE_SPACE}*{EOL}                  { yybegin(YYINITIAL); return MgcbTokenTypes.WHITE_SPACE; }
<WAITING_OPTION_VALUE> {OPTION_VALUE}                       { yybegin(WAITING_WHITESPACE); return MgcbTokenTypes.OPTION_VALUE; }
...
<WAITING_SET_KEY> {WHITE_SPACE}*{EOL}                       { yybegin(YYINITIAL); return MgcbTokenTypes.WHITE_SPACE; }
<WAITING_SET_KEY> {EQ}                                      { yybegin(WAITING_SET_VALUE); return MgcbTokenTypes.EQ; }
<WAITING_SET_VALUE> {PREPROCESSOR_VALUE}                    { yybegin(WAITING_WHITESPACE); return MgcbTokenTypes.PREPROCESSOR_VALUE; }
...
<WAITING_IF_KEY> {WHITE_SPACE}*{EOL}                        { yybegin(YYINITIAL); return MgcbTokenTypes.WHITE_SPACE; }
<WAITING_IF_KEY> {EQ}                                       { yybegin(WAITING_IF_VALUE); return MgcbTokenTypes.EQ; }
<WAITING_IF_VALUE> {PREPROCESSOR_VALUE}                     { yybegin(WAITING_WHITESPACE); return MgcbTokenTypes.PREPROCESSOR_VALUE; }
<YYINITIAL> {ENDIF_KEYWORD}                                 { yybegin(YYINITIAL); return MgcbTokenTypes.ENDIF_KEYWORD; }

<WAITING_WHITESPACE> ({CRLF}|{WHITE_SPACE})+                { yybegin(YYINITIAL); return MgcbTokenTypes.WHITE_SPACE; }
<YYINITIAL> ({CRLF}|{WHITE_SPACE})+                         { yybegin(YYINITIAL); return MgcbTokenTypes.WHITE_SPACE; }
